(function () {
    ...
    function (e) {
        "use strict";
        var a = ["backbutton", "online", "offline", "pause", "resume", "swipeRefresh", "appLinkResponse", "internalPageLinkResponse", "networkEvent", "hostTaskEvent", "autoCheckIn", "becomeActive", "keepAlive"];
        e.extend(e, {
            events: a
        })
    }(window.__dd),
        ...
        var a = "2.3.0",
            n = {
                ...
                biz: [{
                    ...
                    namespace: "biz.live.listLiveRecords",
                    name: "获取录播列表",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.live.getLiveStatistics",
                    name: "获取录播统计信息",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.live.listLiveViewers",
                    name: "获取观众列表",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.live.nav2GroupAnchorList",
                    name: "跳转群主播列表页面",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.live.nav2PlayVideo",
                    name: "跳转至播放页面",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.live.showPlayer",
                    name: "展示直播播放器",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.live.destroyPlayer",
                    name: "销毁播放器",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.util.shareImage",
                    name: "分享图片，可传入图片链接，也可由容器自动抓取当前容器内容",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.util.saveImage",
                    name: "保存图片，可传入图片链接，也可由容器自动抓取当前容器内容",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.contact.pickJobTitle",
                    name: "选择职务",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.oa.authorityVerify",
                    name: "校验页面是否有权限设置工作首页链接",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.zoloz.zimIdentity",
                    name: "启动生物识别认证接口",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "biz.zoloz.download",
                    name: "下载算法模型",
                    ios: "4.2",
                    android: "4.2",
                    release: !1
                }, {
                    namespace: "biz.schedule.create",
                    name: "创建日程",
                    ios: "4.2",
                    android: "4.2",
                    release: !1
                }, {
                    namespace: "biz.navigation.setPullGesture",
                    name: "设置当前页面(容器实例)是否支持设置收纳到缩略图功能",
                    ios: "4.2",
                    android: "4.2",
                    release: !1
                }, {
                    namespace: "biz.contact.isForeignOrg",
                    name: "判断corpId对应的企业是否是海外企业",
                    ios: "4.2",
                    android: "4.2",
                    release: !1
                }, {
                    namespace: "biz.live.initPlayer",
                    name: "初始化直播播放器",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.live.playerPlay",
                    name: "直播播放器播放",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.live.playerPause",
                    name: "直播播放器暂停",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.live.hidePlayer",
                    name: "隐藏直播播放器",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.contact.addSubManager",
                    name: "跳转到添加子管理员界面",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "biz.faceBox.sendMessageToContact",
                    name: " 发送消息",
                    ios: "4.2.8",
                    android: "4.2.",
                    release: !1
                }, {
                    namespace: "biz.faceBox.experienceFunction",
                    name: "体验功能",
                    ios: "4.2.8",
                    android: "4.2.8",
                    release: !1
                }, {
                    namespace: "biz.faceBox.startCameraRecordFromPartner",
                    name: "唤起人脸录入界面",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.chat.addGroup",
                    name: "自己加入一个公开群",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.chat.createOrgPublicGroup",
                    name: "跳转到创建群群中间页让用户创建某个企业的公开群",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.chat.modifyGroupDesc",
                    name: "跳转到群简介修改界面修改某个群的群简介",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.navigation.showPopdownList",
                    name: "navigationBar展示下拉列表",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.navigation.setSubtitle",
                    name: "navigationBar 小标题",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                }, {
                    namespace: "biz.navigation.setTitleIcon",
                    name: "在标题旁边设置一个icon",
                    ios: "4.3",
                    android: "4.3",
                    release: !1
                    ...
                    namespace: "biz.calendar.datePicker",
                    name: "Calendar组件",
                    ios: "不支持",
                    android: "4.3.2",
                    release: !1
                }, {
                    namespace: "biz.util.uploadMedia",
                    name: "上传视频",
                    ios: "不支持",
                    android: "4.3.2",
                    release: !1
                ...
                runtime: [{
                    ...
                    namespace: "runtime.monitor.finishLoad",
                    name: "H5端通知客户端业务加载成功，客户端返回用户操作触发容器加载的时间",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "runtime.info.status",
                    name: "获取当前容器状态",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                ...
                internal: [{
                    ...
                    namespace: "internal.util.getBindSmartDeviceOrgList",
                    name: "获取绑定了智能设备的企业列表",
                    ios: "4.0",
                    android: "4.0",
                    release: !1
                }, {
                    namespace: "internal.search.debug",
                    name: "搜索调试",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "internal.util.authAlipayInvoice",
                    name: "唤起支付宝, 获取授权auto_code",
                    ios: "4.1",
                    android: "4.1",
                    release: !1
                }, {
                    namespace: "internal.guide.closeGuideBanner",
                    name: "关闭蓝条引导",
                    ios: "4.2",
                    android: "4.2",
                    release: !1
                }, {
                    namespace: "internal.cspace.decryptAndUpload",
                    name: "客户端下载钉盘文件，本地解密，并上传到个人临时空间",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1,
                    defaultParams: {
                    ...
                    namespace: "internal.cspace.cancelDecryptAndUpload",
                    name: "取消（下载、解密、上传）的过程",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "internal.cspace.openFolder",
                    name: "进入钉盘指定目录",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "internal.safe.getAppInfo",
                    name: "获取App信息",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "internal.safe.getDeviceInfo",
                    name: "获取设备相关信息",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "internal.safe.scanPlugin",
                    name: "iOS 越狱插件行为扫描",
                    ios: "4.2.5",
                    android: "4.2.5",
                    release: !1
                }, {
                    namespace: "internal.contact.internalComplexPicker",
                    name: "企业主页选人组件",
                    ios: "4.2.8",
                    android: "4.2.8",
                    release: !1
                }, {
                    namespace: "internal.redpacket.nav2RedPacket",
                    name: "红包组件",
                    ios: "4.3.0",
                    android: "4.3.0",
                    release: !1
                }, {
                    namespace: "internal.notify.showModal",
                    name: "全屏浮层弹框，全屏遮罩",
                    ios: "4.3.0",
                    android: "4.3.0",
                    release: !1
                }, {
                    namespace: "internal.notify.closeModal",
                    name: "关闭全屏浮层弹框，全屏遮罩",
                    ios: "4.3.0",
                    android: "4.3.0",
                    release: !1
                ...
                util: [{
                    ...
                    namespace: "util.cookies.write",
                    name: "将指定cookie保存到本地cookiestorage",
                    ios: "4.0",
                    android: "无",
                    release: !1
                }, {
                    namespace: "util.cookies.read",
                    name: "读取本地cookiestorage中在指定域名下的cookie",
                    ios: "4.0",
                    android: "无",
                    release: !1
                }],
                ...
                net: [{
                    namespace: "net.vpn.check",
                    name: "检查深信服vpn是否连接",
                    ios: "4.1",
                    android: "4.1"
                }, {
                    namespace: "net.vpn.start",
                    name: "启动深信服vpn",
                    ios: "4.1",
                    android: "4.1"
                }, {
                    namespace: "net.vpn.stop",
                    name: "关闭深信服vpn",
                    ios: "4.1",
                    android: "4.1"
                }, {
                    namespace: "net.tunnel.request",
                    name: "设客户端提供代理，来发送https请求",
                    ios: "4.2",
                    android: "无"
                }],
                service: [{
                ...
                retail: [{
                    namespace: "retail.chat.open",
                    name: "在新零售场景，打开会话",
                    ios: "4.3.0",
                    android: "4.3.0"
                }, {
                    namespace: "retail.telephone.call",
                    name: "新增JSAPI, 在新零售场景，直接发起办公电话",
                    ios: "4.3.0",
                    android: "4.3.0"
                }]
            };
            ...
            ready: function (n) {
                var i = this,
                    c = function (a) {
                        ...
                        if (null === s) m || (console.log("没有配置dd.config"), m = !0), n(a);
                        ...
                        if (o === !1 && (o = !0, e.events.forEach(function (n) {
                            ...
                            }), location.host && location.host.indexOf("dingtalk.com") > -1 && (e.internal.log.add({
                                text: "dd.ready"
                ...
                if (e.ios) document.addEventListener("WebViewJavascriptBridgeReady", function () {
                    ...
                    t = !0, c(WebViewJavascriptBridge)
                }, !1);
                else {
                    if (!e.android) return console.log("请在钉钉App打开此页面");
                    var p = function () {
                        try {
                            a.WebViewJavascriptBridgeAndroid = a.nuva.require(), t = !0, c(WebViewJavascriptBridgeAndroid)
                        } catch (e) {
